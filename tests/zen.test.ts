  ...
  chat: {
    completions: {
      create: vi.fn().mockResolvedValue({
        choices: [{ message: { content: "This verse describes the act of creation." } }],
      }),
    },
  },
};
...
const mockWasmPipeline = vi.fn().mockResolvedValue([
  { generated_text: "PROMPT_PREFIX This verse explains cosmic origins in a spiritual context." },
]);
